...
RSpec.describe BorrowersController, type: :controller do
  ...
  describe "GET #index" do
    it "assigns all borrowers as @borrowers" do
      ...
      expect(assigns(:borrowers)).to eq([borrower])
    end
  end
  ...
  describe "GET #new" do
    it "assigns a new borrower as @borrower" do
      ...
      expect(assigns(:borrower)).to be_a_new(Borrower)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "assigns a newly created borrower as @borrower" do
        post :create, params: {borrower: valid_attributes}, session: valid_session
        expect(assigns(:borrower)).to be_a(Borrower)
        expect(assigns(:borrower)).to be_persisted
      end
